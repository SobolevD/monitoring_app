...
public abstract class PropertiesNames {
    ...
    public static final String TASK_COLLECT_PROCESSES_DELAY_SECONDS_PROP = "task.collect.processes.delay.seconds";
    public static final String TASK_COLLECT_PROCESSES_PERIOD_SECONDS_PROP = "task.collect.processes.period.seconds";
}
